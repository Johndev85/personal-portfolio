    ...
    return (
        <article id="aboutme" className={styles.container}>
            ...
            <section className={styles.container__text}>
                ...
                <p>
                    Me gusta crear interfaces y sitios web interactivos que
                    brinden soluciones ágiles y suplan las necesidades de la
                    nueva era digital. Soy un autodidacta de la educación
                    online, comencé aprendiendo y aplicando implementaciones en
                    Wordpress y luego adelantando la carrera de desarrollo web
                    en el programa especial Platzi Master. <br /> <br />
